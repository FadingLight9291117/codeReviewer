...
### 🎯 多前缀Git提交代码审查
- **智能前缀匹配**: 支持同时匹配多种提交前缀（feat:, ├── ⚙️ config.py                # 配置管理
├── 🎯 multi_prefix_review.py    # 多前缀审查工具
├── 📁 examples/                 # 示例和演示文件夹
│   ├── 🎓 core_review_tutorial.py    # 核心功能教程
│   ├── 🎭 multi_prefix_showcase.py   # 多前缀功能展示
│   └── 🧪 system_validator.py        # 系统验证器
├── 🔄 rename_main.py            # 文件重命名工具
├── 📖 readme.md                 # 项目文档
├── 📋 MULTI_PREFIX_GUIDE.md     # 多前缀工具使用指南
├── 📊 INTEGRATION_REPORT.md     # 集成完成报告
├── ⚙️ config.yaml              # 配置文件tor:等）
- **项目路径指定**: 可以指定不同的项目路径进行审查
- **AI驱动分析**: 使用GPT-4o等先进AI模型进行多维度分析
- **自动报告生成**: 生成结构化的Markdown格式审查报告
